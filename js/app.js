  ...
  load() {
    try {
      ...
      if (raw) {
        ...
        // Merge settings, but always ensure effectsEnabled defaults to true if not explicitly set
        const savedSettings = data.settings || {};
        App.settings = Object.assign({}, App.settings, savedSettings);
        // Migration: if effectsEnabled is not in saved data, default to true
        if (savedSettings.effectsEnabled === undefined) {
